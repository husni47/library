...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO Relasi_Buku_Kategori (id_buku, id_kategori) VALUES (?, ?)");
...
<head>
    ...
    <title>Tambah Relasi Buku Kategori</title>
</head>
<body>
    <div class="container">
        <h1 class="mt-5">Tambah Relasi Buku Kategori</h1>
