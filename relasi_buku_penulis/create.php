...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO Relasi_Buku_Penulis (id_buku, id_penulis) VALUES (?, ?)");
...
<head>
    ...
    <title>Tambah Relasi Buku Penulis</title>
</head>
<body>
    <div class="container">
        <h1 class="mt-5">Tambah Relasi Buku Penulis</h1>
