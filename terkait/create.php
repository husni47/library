...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO Terkait (id_peminjaman, id_detail_peminjaman) VALUES (?, ?)");
...
<head>
    ...
    <title>Tambah Terkait</title>
</head>
<body>
    <div class="container">
        <h1 class="mt-5">Tambah Terkait</h1>
        <form method="POST" class="mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id_detail_peminjaman" name="id_detail_peminjaman" required>
            </div>
